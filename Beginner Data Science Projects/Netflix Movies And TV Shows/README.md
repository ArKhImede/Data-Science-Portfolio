...
Exploratory Data Analysis (EDA) project using the Netflix Movies & TV Shows dataset. This beginner-friendly project explores Netflix content trends using Python, Pandas, and Matplotlib.
